...
todos:
  ...
  - id: parser-tests
    ...
    status: pending
    blocked_by: [tokenizer-seam]
    files: [tests/test_parse.py]
  - id: tokenizer-seam
    content: "PREREQUISITE: expose tinycalc.tokenize so parser tests are not vacuous"
    status: pending
  - id: readme-usage
    content: "Document parse and add usage in README.md"
    status: pending
    files: [README.md]
